        ...
        <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor">
                        <a href="doctors.php" class="non-style-link-menu"><div><p class="menu-text">All Customers</p></a></div>
                    </td>
                </tr>
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div class="h3-search">
                                                                ...
                                                                <div class="h4-search">
                                                                    Scheduled Date: '.$scheduledate.'<br>Time <b>'.substr($scheduletime,0,5).'</b> (24h)
                                                                </div>
                                                                <br>
